...
describe JsonSchema::Validator do
  ...
  it "validates date-time format with time zone with colon successfully" do
    pointer("#/definitions/app/definitions/owner").merge!(
      "format" => "date-time"
    )
  ...
  it "validates date-time format with time zone without colon successfully" do
    pointer("#/definitions/app/definitions/owner").merge!(
      "format" => "date-time"
    )
    data_sample["owner"] = "2014-05-13T08:42:40-0000"
    assert validate
  end

  it "validates date-time format with time zone without minutes successfully" do
    pointer("#/definitions/app/definitions/owner").merge!(
      "format" => "date-time"
    )
    data_sample["owner"] = "2014-05-13T08:42:40-00"
    assert validate
  end
